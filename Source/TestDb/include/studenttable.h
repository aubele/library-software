...
public:
    ...
    virtual QList<StudentRow> getAllStudents();
    virtual QList<StudentRow> getStudentsByClassName(QString className);
    virtual QList<ClassTable::ClassRow> getClassesFromStudent(QString preName, QString surName, QString dateOfBirth);
